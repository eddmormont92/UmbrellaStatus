...
async function fetchCdfStatus() {
  try {
    ...
    const serviceStatus = await page.evaluate(() => {
      const statusElement = document.querySelector('#serviceCloudDeliveredFirewall');
      if (statusElement) {
    ...
    console.error('Error fetching CDF status:', error);
    return 'Error fetching status';
  }
}

// Export the function
module.exports = fetchCdfStatus;
